...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'dfcde1c6'])
Z([3,'_view dfcde1c6 content'])
Z([3,'index'])
Z([3,'message'])
Z([[7],[3,'messages']])
Z(z[2])
Z([3,'_view dfcde1c6 item'])
Z([[7],[3,'index']])
Z([3,'_view dfcde1c6 item-left'])
Z([3,'_image dfcde1c6'])
Z([[6],[[7],[3,'message']],[3,'avatar']])
Z([3,'_view dfcde1c6 item-center'])
Z([3,'_text dfcde1c6 name'])
Z([a,[[6],[[7],[3,'message']],[3,'name']]])
Z([3,'_text dfcde1c6 content'])
Z([a,[[6],[[7],[3,'message']],[3,'content']]])
Z([3,'_view dfcde1c6 item-right'])
Z([3,'_text dfcde1c6 time'])
...
Z([3,'_view 81f2e266'])
Z([3,'_text 81f2e266 title'])
Z([a,[[7],[3,'name']]])
Z([3,'_navigator 81f2e266'])
Z([3,'navigator-hover'])
Z([3,'setting'])
Z([3,'_button 81f2e266'])
Z([3,'primary'])
Z([3,'个人设置'])
